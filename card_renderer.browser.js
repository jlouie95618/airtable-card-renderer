...
(function() {
    var root = this;
    var previousCompactCard = root.CompactCard;
    ...
    if (typeof _ === 'undefined') {
        if (has_require) { _ = require('underscore'); }
        else { throw new Error('compact_card requires Underscore'); }
    }

    if (typeof Class === 'undefined') {
        if (has_require) { Class = require('../vendor/class.js'); }
        else { throw new Error('compact_card requires the Class file'); }
    }

    if (typeof ColumnTypeConstructors === 'undefined') {
        if (has_require) { ColumnTypeConstructors = require('../column_types.js'); }
        else { throw new Error('compact_card requires the ColumnTypeConstructors file'); }
    }

    if (typeof config === 'undefined') {
        if (has_require) { config = require('../config.js'); }
        else { throw new Error('compact_card requires the config file'); }
    }
    ...
    if (typeof exports !== 'undefined') {
        if (typeof module !== 'undefined' && module.exports) {
            exports = module.exports = CompactCard;
        }
        exports.CompactCard = CompactCard;
    } else {
        root.CompactCard = CompactCard;
    }

}).call(this);

},{"../column_types.js":5,"../config.js":6,"../vendor/class.js":28,"underscore":9}],4:[function(require,module,exports){
'use strict'; // indicate to use Strict Mode
...
},{"../generic_column_type.js":7,"underscore":9}],28:[function(require,module,exports){
/*jshint strict:false */
